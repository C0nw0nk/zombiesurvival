...
GM.WaveOneZombies = math.ceil(100 * CreateConVar("zs_waveonezombies", "0.25", FCVAR_REPLICATED + FCVAR_ARCHIVE + FCVAR_NOTIFY, "The percentage of players that will start as zombies when the game begins."):GetFloat()) * 0.01
